...
train_dataset = TextClassificationDataset(json_file="train.json", tokenizer=tokenizer)
test_dataset = TextClassificationDataset(json_file="test.json", tokenizer=tokenizer)
